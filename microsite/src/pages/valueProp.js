...
const cardContents = [
    {
        title: "Reduce Cost",
        description: "Know where to target your optimizations, such as reducing " +
    ...
    },
    {
        ...
        description: "Measure your emissions over time and see what workloads are " +
    ...
    },
    {
        ...
        description: "Demonstrate a commitment to sustainability and enable " +
    ...
    },
    {
        ...
        description: "Enable engineers to monitor emissions and usage daily. This allows for " +
                ...
                <div>
                    <div className={styles.valuePropCardHeaderContainer}>
                        ...
                        <div className={styles.valuePropCardTitleContainer}>
                            <p className={styles.valuePropCardTitle}>{title}</p>
                        </div>
                    </div>
...
function ValueProp() {
    return (
        <div className="home__subsection-box-format">
            <p className="home__subsection-title">MEASURE AND CONTROL YOUR IMPACT</p>
