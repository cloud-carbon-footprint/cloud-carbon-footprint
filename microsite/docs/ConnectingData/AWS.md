...
1.  Ensure your aws account has the correct permissions
    ...
    - IAM permissions are not required to run the app.
...
4.  Configure aws credentials locally, using awscli.
    ...
    - We optionally support alternative methods of authenticating with AWS, which you can read about [here.](#options-for-aws-authentication)
