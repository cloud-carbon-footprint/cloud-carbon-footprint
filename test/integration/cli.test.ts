  ...
  test('cli integration test', async () => {
    ...
    expect(result).toEqual(
      '| Date (UTC)   | EBS Wattage  | EBS CO2e Emissions     | S3 Wattage   | S3 CO2e Emissions      | EC2 Wattage  | EC2 CO2e Emissions     | Sum Wattage  | Sum CO2e Emissions     \n' +
        '| 2020-06-27   | 0.86 Watts   | 0.000611 Kg CO2e       | 0.00 Watts   | 0.000000 Kg CO2e       | 0.00 Watts   | 0.000000 Kg CO2e       | 0.86 Watts   | 0.000611 Kg CO2e       \n' +
        ...
        '| Total        | 2.59 Watts   | 0.001833 Kg CO2e       | 0.00 Watts   | 0.000000 Kg CO2e       | 0.00 Watts   | 0.000000 Kg CO2e       | 2.59 Watts   | 0.001833 Kg CO2e       ',
    )
  })
})
