  ...
  it('prints out the given estimation results grouped by date', () => {
    expect(result.table).toEqual([
      [
        'Date (UTC)',
        'EBS Watt Hours',
        'EBS mt CO2e Emissions',
        'S3 Watt Hours',
        'S3 mt CO2e Emissions',
        'EC2 Watt Hours',
        'EC2 mt CO2e Emissions',
        'ElastiCache Watt Hours',
        'ElastiCache mt CO2e Emissions',
        'RDS Watt Hours',
        'RDS mt CO2e Emissions',
        'Lambda Watt Hours',
        'Lambda mt CO2e Emissions',
        'ComputeEngine Watt Hours',
        'ComputeEngine mt CO2e Emissions',
        'SUM Watt Hours',
        'SUM mt CO2e Emissions',
      ],
      [
        '2020-07-09',
        '7.00',
