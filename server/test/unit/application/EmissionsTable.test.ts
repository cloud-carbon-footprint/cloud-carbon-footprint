...
describe('EmissionsTable', () => {
  ...
  it('prints out the given estimation results for the provided services', () => {
    const input: EstimationResult[] = [
      {
        timestamp: moment('2020-07-10').toDate(),
        estimates: [
    ...
    const result: string = EmissionsTable(input, ['ebs', 's3', 'elasticache'])
