...
- f06b4775: Adds custom pagination to the top and bottom of the recommendations table
...
- f06b4775: Allow recommendations side panel to be opened and closed by clicking the same recommendation row. Also fixed bug where side panel would not reopen for same recommendation row after being closed
- f06b4775: Adds mobile incompatibility warning for devices smaller than intended screen size
...
- f06b4775: Update messaging on recs table when no data due to filtering
...
- f06b4775: Cache produces different data depending on which page is loaded
...
- f06b4775: Metric tons / kg toggle applies to full recs dashboard
...
- f06b4775: Updates packages axios, googleapis and @changesets/cli
- f06b4775: Fixes filters bug not being able to apply more than 1 filter on recs page
...
- f06b4775: Searching in recs table does not work for kg
...
- f06b4775: Filter dropdown for Recommendations should not side scroll
...
- f06b4775: Stop rounding to 0 in rec table and enable search for co2 savings in kg
- f06b4775: adds embodied emissions documentation to client side panel
