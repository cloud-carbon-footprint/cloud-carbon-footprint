...
import { ALL_ACCOUNTS_DROPDOWN_OPTION, buildAndOrderDropdownOptions } from './DropdownConstants'
...
const AccountFilter: FunctionComponent<FilterProps> = ({ filters, setFilters, options }) => {
  const allDropdownAccountOptions = buildAndOrderDropdownOptions(options?.accounts, EMPTY_RESPONSE)
