...
export const VIRTUAL_MACHINE_TYPE_VCPU_MEMORY_MAPPING: {
  [instanceType: string]: number[] // [vcpus, memory, embodied emissions]
} = {
  'vCPU Duration': [1],
  vCore: [1],
  '2 vCore': [2],
  ...
  'DS11-1 v2': [1, 14, 1.15],
  'DS12-1 v2': [1, 28, 1.1666428],
  'DS12-2 v2': [2, 28, 1.1666428],
  'E4-2as v4': [2, 32, 1.1721904],
  'E4-2ds v4': [2, 32, 1.1721904],
  'E4-2s v3': [2, 32, 1.1721904],
  'E4-2s v4': [2, 32, 1.1221904],
  'DS13-2 v2': [2, 56, 1.205476],
  'DS13-4 v2': [4, 56, 1.205476],
  'E8-2as v4': [2, 64, 1.2165712],
  'E8-2ds v4': [2, 64, 1.2165712],
  'E8-2s v3': [2, 64, 1.2165712],
  'E8-2s v4': [2, 64, 1.1665712],
  'E8-4as v4': [4, 64, 1.2165712],
  'E8-4ds v4': [4, 64, 1.2165712],
  'E8-4s v3': [4, 64, 1.2165712],
  'E8-4s v4': [4, 64, 1.1665712],
  'DS14-4 v2': [4, 112, 1.2831424],
  'DS14-8 v2': [8, 112, 1.2831424],
  'E16-4as v4': [4, 128, 1.3053328],
  'E16-4ds v4': [4, 128, 1.3053328],
  'E16-4s v3': [4, 128, 1.3053328],
  'E16-4s v4': [4, 128, 1.2553328],
  'M8-2ms': [2, 219, 1.4315407],
  'M8-4ms': [4, 219, 1.4315407],
  'Gs4-4': [4, 224, 1.4384752],
  'Gs4-8': [8, 224, 1.4384752],
  'M16-4ms': [4, 438, 1.7352718],
  'M16-8ms': [8, 438, 1.7352718],
  'E16-8as v4': [8, 128, 1.3053328],
  'E16-8ds v4': [8, 128, 1.3053328],
  'E16-8s v3': [8, 128, 1.3053328],
  'E16-8s v4': [8, 128, 1.2553328],
  'E32-8as v4': [8, 256, 1.482856],
  'E32-8ds v4': [8, 256, 1.482856],
  'E32-8s v3': [8, 256, 1.482856],
  'E32-8s v4': [8, 256, 1.432856],
  'Gs5-8': [8, 448, 1.7491408],
  'Gs5-16': [16, 448, 1.7491408],
  'M32-8ms': [8, 875, 2.3413471],
  'E32-16as v4': [16, 256, 1.482856],
  'E32-16ds v4': [16, 256, 1.482856],
  'E32-16s v3': [16, 256, 1.482856],
  'E32-16s v4': [16, 256, 1.432856],
  'E64-16s v3': [16, 432, 1.7269504],
  'E64-32s v3': [32, 432, 1.7269504],
  'HB120-16rs v3': [16, 448, 1.6491408],
  'HB120-32rs v3': [32, 448, 1.6491408],
  'HB120-64rs v3': [64, 448, 1.6491408],
  'HB120-96rs v3': [96, 448, 1.6491408],
  'E64-16ds v4': [16, 504, 1.8268072],
  'E64-16s v4': [16, 504, 1.7768072],
  'E64-16as v4': [16, 512, 1.8379024],
  'M32-16ms': [16, 875, 2.3413471],
  'M64-16ms': [16, 1750, 3.5548846],
  'E96-24as v4': [24, 672, 2.0598064],
  'E64-32ds v4': [32, 504, 1.8268072],
  'E64-32s v4': [32, 504, 1.7768072],
  'E64-32as v4': [32, 512, 1.8379024],
  'M64-32ms': [32, 1750, 3.5548846],
  'M128-32ms': [32, 3800, 6.3980296],
  'E96-48as v4': [48, 672, 2.0598064],
  'M128-64ms': [64, 3800, 6.3980296],
}
