...
describe('Azure Consumption Management Service', () => {
  ...
  it.each([
    [GroupBy.day, new Date('2020-01-01'), new Date('2021-02-05T23:59:59.999Z')],
    [
      GroupBy.week,
      new Date('2019-12-30'),
      new Date('2021-02-07T23:59:59.999Z'),
    ],
    [
      GroupBy.month,
      new Date('2020-01-01'),
      new Date('2021-02-28T23:59:59.999Z'),
    ],
    [
      GroupBy.quarter,
      new Date('2020-01-01'),
    ...
    (groupBy: GroupBy, start: Date, end: Date) => {
      const consumptionManagementService = new ConsumptionManagementService(
        new ComputeEstimator(),
        new StorageEstimator(AZURE_CLOUD_CONSTANTS.SSDCOEFFICIENT),
        new StorageEstimator(AZURE_CLOUD_CONSTANTS.HDDCOEFFICIENT),
      ...
      const result = consumptionManagementService.getGroupByDates(
        new Date('2020-01-01'),
        new Date('2021-02-05'),
        groupBy,
      )
