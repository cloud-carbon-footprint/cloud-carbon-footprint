...
export const AZURE_EMISSIONS_FACTORS_METRIC_TON_PER_KWH: CloudConstantsEmissionsFactors =
  {
    // Africa regions
    [AZURE_REGIONS.AF_SOUTH_AFRICA.name]: 0.000928,
    [AZURE_REGIONS.AF_SOUTH_AFRICA_NORTH.name]: 0.000928,
    [AZURE_REGIONS.AF_SOUTH_AFRICA_WEST.name]: 0.000928,
    
    // APAC regions
    [AZURE_REGIONS.AP_AUSTRALIA.name]: 0.000790,
    [AZURE_REGIONS.AP_AUSTRALIA_CENTRAL.name]: 0.000790,
    [AZURE_REGIONS.AP_AUSTRALIA_CENTRAL2.name]: 0.000790,
    [AZURE_REGIONS.AP_AUSTRALIA_EAST.name]: 0.000790,
    [AZURE_REGIONS.AP_AUSTRALIA_SOUTH_EAST.name]: 0.000790,
    
    [AZURE_REGIONS.AP_EAST.name]: 0.00081,
    [AZURE_REGIONS.AP_SOUTH_EAST.name]: 0.0004085,
    
    [AZURE_REGIONS.AP_JAPAN_EAST.name]: 0.000506,
    [AZURE_REGIONS.AP_JAPAN_WEST.name]: 0.000506,
    [AZURE_REGIONS.AP_JAPAN.name]: 0.000506,
    
    [AZURE_REGIONS.AP_KOREA.name]: 0.000500,
    [AZURE_REGIONS.AP_KOREA_EAST.name]: 0.000500,
    [AZURE_REGIONS.AP_KOREA_SOUTH.name]: 0.000500,
    
    [AZURE_REGIONS.ASIA.name]: 0.0005647,
    [AZURE_REGIONS.ASIA_PACIFIC.name]: 0.0005647,
    [AZURE_REGIONS.ASIA_EAST.name]: 0.000810,
    [AZURE_REGIONS.ASIA_EAST_STAGE.name]: 0.000810,
    [AZURE_REGIONS.ASIA_SOUTH_EAST.name]: 0.0004085,
    [AZURE_REGIONS.ASIA_SOUTH_EAST_STAGE.name]: 0.0004085,

    [AZURE_REGIONS.INDIA.name]: 0.000708,
    [AZURE_REGIONS.IN_CENTRAL.name]: 0.000708,
    [AZURE_REGIONS.IN_JIO_CENTRAL.name]: 0.000708,
    [AZURE_REGIONS.IN_JIO_WEST.name]: 0.000708,
    ...
    [AZURE_REGIONS.EU_FRANCE_CENTRAL.name]: 0.00003895,
    [AZURE_REGIONS.EU_FRANCE_SOUTH.name]: 0.00003895,
    [AZURE_REGIONS.EU_FRANCE.name]: 0.00003895,
    
    [AZURE_REGIONS.EU_SWEDEN_CENTRAL.name]: 0.00001189,
    
    [AZURE_REGIONS.EU_SWITZERLAND.name]: 0.00001182,
    [AZURE_REGIONS.EU_SWITZERLAND_NORTH.name]: 0.00001182,
    [AZURE_REGIONS.EU_SWITZERLAND_WEST.name]: 0.00001182,
    
    [AZURE_REGIONS.UK_SOUTH.name]: 0.000228,
    [AZURE_REGIONS.UK_WEST.name]: 0.000228,
    [AZURE_REGIONS.EU_UK.name]: 0.000228,
    
    [AZURE_REGIONS.EU_GERMANY.name]: 0.00037862,
    [AZURE_REGIONS.EU_GERMANY_NORTH.name]: 0.00037862,
    [AZURE_REGIONS.EU_GERMANY_WESTCENTRAL.name]: 0.00037862,
    [AZURE_REGIONS.EU_NORWAY.name]: 0.00001118,
    [AZURE_REGIONS.EU_NORWAY_EAST.name]: 0.00001118,
    [AZURE_REGIONS.EU_NORWAY_WEST.name]: 0.00001118,

    // Middle east regions
    [AZURE_REGIONS.ME_UAE.name]: 0.0004258,
    [AZURE_REGIONS.ME_UAE_CENTRAL.name]: 0.0004258,
    [AZURE_REGIONS.ME_UAE_NORTH.name]: 0.0004258,

    // Americas regions
    [AZURE_REGIONS.US_CANADA.name]: 0.00013,
    [AZURE_REGIONS.US_CANADA_CENTRAL.name]: 0.00013,
    [AZURE_REGIONS.US_CANADA_EAST.name]: 0.00013,
    ...
    [AZURE_REGIONS.US_CENTRAL_STAGE.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.MRO,
    ...
    [AZURE_REGIONS.US_EAST_2_STAGE.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.SERC,
    ...
    [AZURE_REGIONS.US_NORTH_CENTRAL.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.RFC,
    [AZURE_REGIONS.US_NORTH_CENTRAL_STAGE.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.RFC,
    
    [AZURE_REGIONS.US_SOUTH_CENTRAL.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.TRE,
    [AZURE_REGIONS.US_SOUTH_CENTRAL_STAGE.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.TRE,
    
    [AZURE_REGIONS.US_WEST_CENTRAL.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.WECC,
    ...
    [AZURE_REGIONS.US_WEST_2_STAGE.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.WECC,
    [AZURE_REGIONS.US_WEST_3.name]: US_NERC_REGIONS_EMISSIONS_FACTORS.WECC,

    [AZURE_REGIONS.BRAZIL.name]: 0.000074,
    [AZURE_REGIONS.BRAZIL_SOUTH.name]: 0.000074,
    [AZURE_REGIONS.BRAZIL_SOUTH_EAST.name]: 0.000074,
