...
export const AZURE_EMISSIONS_FACTORS_METRIC_TON_PER_KWH: CloudConstantsEmissionsFactors =
  {
    ...
    [AZURE_REGIONS.AP_AUSTRALIA_SOUTH_EAST.name]: 0.00079,
    ...
    [AZURE_REGIONS.AP_KOREA.name]: 0.0005,
    [AZURE_REGIONS.AP_KOREA_EAST.name]: 0.0005,
    [AZURE_REGIONS.AP_KOREA_SOUTH.name]: 0.0005,

    [AZURE_REGIONS.ASIA.name]: 0.0005647,
    [AZURE_REGIONS.ASIA_PACIFIC.name]: 0.0005647,
    [AZURE_REGIONS.ASIA_EAST.name]: 0.00081,
    [AZURE_REGIONS.ASIA_EAST_STAGE.name]: 0.00081,
