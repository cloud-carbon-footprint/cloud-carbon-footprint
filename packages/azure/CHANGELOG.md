...
- 3743b69e: removes grouping date logic from azure to cache decorator
- 314c4fdc: updates groupby logic for azure date range

### Patch Changes

- b53b36de: Add new azure Storage usage
