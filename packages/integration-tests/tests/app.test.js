...
test.skip('main components render with correct data when app loads', async (t) => {
  await t
...
test.skip('side drawer opens and closes when clicked', async (t) => {
...
test.skip('total metric tons is loaded correctly with different dropdown selections', async (t) => {
...
test.skip('carbon equivalency component displays each option when clicked', async (t) => {
  await t
...
test.skip('emissions breakdown component displays each bar chart when selected', async (t) => {
...
test.skip('line chart displays the y-axis data when legend is clicked', async (t) => {
