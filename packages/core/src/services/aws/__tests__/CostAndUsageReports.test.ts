  ...
  it('Gets Estimates for Kinesis, ES & EC2 Spot Instance', async () => {
    ...
    const expectedResult: EstimationResult[] = [
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.5814204345,
            co2e: 0.00026425558748024996,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountName: '123456789',
            serviceName: 'AmazonEC2',
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.000015859972403186278,
            cost: 4,
            region: 'us-west-1',
            serviceName: 'AmazonMSK',
            usesAverageCPUConstant: true,
            kilowattHours: 0.045116596175,
          },
        ],
      },
    ]
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.000030279773274235333,
            cost: 5,
            region: 'us-west-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.08613636066666666,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.0005276359989178824,
            cost: 25,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 1.5009572327999998,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.000027188524119747902,
            cost: 20,
            region: 'us-west-1',
            serviceName: 'ElasticMapReduce',
            usesAverageCPUConstant: true,
            kilowattHours: 0.0773427363,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
        ...
        serviceEstimates: [
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.000093823843987875,
            cost: 40,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.20643310008333332,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
