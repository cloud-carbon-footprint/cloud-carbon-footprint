  ...
  it('Gets Estimates for Kinesis, ES & EC2 Spot Instance', async () => {
    ...
    const expectedResult: EstimationResult[] = [
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.8405474039999998,
            co2e: 0.0003820287951179999,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountName: '123456789',
            serviceName: 'AmazonEC2',
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00004741478524193321,
            cost: 4,
            region: 'us-west-1',
            serviceName: 'AmazonMSK',
            usesAverageCPUConstant: true,
            kilowattHours: 0.1348800404,
          },
        ],
      },
    ]
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00004029223999964799,
            cost: 5,
            region: 'us-west-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.11461865599999999,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.0005531892946262592,
            cost: 25,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 1.5736482623999999,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00009100724671496641,
            cost: 20,
            region: 'us-west-1',
            serviceName: 'ElasticMapReduce',
            usesAverageCPUConstant: true,
            kilowattHours: 0.2588867808,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
        ...
        serviceEstimates: [
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.0344355816191751,
            cost: 40,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 75.76585614780001,
          },
        ],
      },
    ]
