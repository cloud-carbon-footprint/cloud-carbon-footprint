    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.0019976000000000004,
            co2e: 8.305121880000002e-7,
          ...
          {
            kilowattHours: 0.0009988000000000002,
            co2e: 4.396587756000001e-7,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountName: '123456789',
            serviceName: 'AmazonEC2',
  ...
  it('Gets Estimates for Kinesis, ES & EC2 Spot Instance', async () => {
    ...
    const expectedResult: EstimationResult[] = [
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.6656545503000001,
            co2e: 0.00027674920755997655,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountName: '123456789',
            serviceName: 'AmazonEC2',
        ...
        serviceEstimates: [
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00005489562434475,
            cost: 10,
            region: 'us-west-1',
            serviceName: 'AmazonDocDB',
            usesAverageCPUConstant: true,
            kilowattHours: 0.15645975,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00003460032906263827,
            cost: 5,
            region: 'us-west-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.09861548893333334,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.0005943346510320746,
            cost: 25,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 1.6939319304000002,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.0004934194732544001,
            cost: 15,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 1.4063104000000004,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
        ...
        serviceEstimates: [
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.00014492520574524827,
            cost: 40,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.3485831938166667,
          },
          {
            accountName: '123456789',
            cloudProvider: 'AWS',
            co2e: 0.000084105592032,
            cost: 7,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.239712,
          },
        ],
      },
    ]
