    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.04514513899824584,
            co2e: 0.000016483745125115724,
          ...
          {
            kilowattHours: 0.021943931013313992,
            co2e: 0.000008253733875512186,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountId: testAccountId,
            accountName: testAccountName,
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000008170193100493411,
            cost: 13,
            region: 'us-west-2',
            serviceName: 'AmazonRDS',
            usesAverageCPUConstant: true,
            kilowattHours: 0.027357065018160803,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
  ...
  it('Gets Estimates for Kinesis, ES & EC2 Spot Instance', async () => {
    ...
    const expectedResult: EstimationResult[] = [
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.6833798473215091,
            co2e: 0.00024952097782500904,
            usesAverageCPUConstant: true,
            cloudProvider: 'AWS',
            accountId: testAccountId,
            accountName: testAccountName,
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000019658682722228422,
            cost: 4,
            region: 'us-west-1',
            serviceName: 'AmazonMSK',
            usesAverageCPUConstant: true,
            kilowattHours: 0.0658251102254754,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00004433395223465754,
            cost: 4,
            kilowattHours: 0.046578084338065526,
            region: 'ap-south-1',
            serviceName: 'AmazonMSK',
            usesAverageCPUConstant: true,
            tags: {
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000007432459565480431,
            cost: 2,
            kilowattHours: 0.024886838912708185,
            region: 'us-west-1',
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00022566711695111606,
            cost: 10,
            region: 'us-west-1',
            serviceName: 'AmazonDocDB',
            usesAverageCPUConstant: true,
            kilowattHours: 0.7556235103573926,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00003111035110251798,
            cost: 5,
            region: 'us-west-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.10416986323101671,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.0005352210795865024,
            cost: 25,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 1.7921336366522236,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00003156018799348747,
            cost: 20,
            region: 'us-west-1',
            serviceName: 'ElasticMapReduce',
            usesAverageCPUConstant: true,
            kilowattHours: 0.10567609655040748,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 2.7994468136055626e-8,
            cost: 10,
            region: 'us-west-1',
            serviceName: 'AmazonRedshift',
            usesAverageCPUConstant: true,
            kilowattHours: 0.00009373664435185185,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.0008301159037595617,
            cost: 15,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 2.7795591208717187,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000035573562357077625,
            cost: 20,
            region: 'ca-central-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.30823639508775347,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00021009611506982525,
            cost: 40,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.5754043298914528,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.00008299246283987963,
            cost: 7,
            region: 'us-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 0.2778918654677533,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 1.798179222541315,
            cost: 20,
            region: 'us-east-1',
            serviceName: 'AmazonRDS',
            usesAverageCPUConstant: true,
            kilowattHours: 4924.794112576731,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000024399243880489962,
            cost: 6,
            region: 'ap-southeast-1',
            serviceName: 'AmazonDocDB',
            usesAverageCPUConstant: true,
            kilowattHours: 0.04933824819624687,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.019335804757417478,
            cost: 10516.725,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: false,
            kilowattHours: 52.95626611494498,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.014908410720447489,
            cost: 10,
            region: 'eu-west-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            kilowattHours: 48.880035149008165,
            tags: {
              'user:Environment': '',
              'aws:CreatedBy': '',
            },
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.000010094200960261373,
            cost: 5,
            kilowattHours: 0.026837120368477817,
            region: 'us-east-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.01631394320368417,
            cost: 10,
            kilowattHours: 44.68009108061476,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.050493706028961714,
            cost: 10,
            kilowattHours: 134.2459568503272,
            region: 'us-east-2',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
        ...
        serviceEstimates: [
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.03262788640736834,
            cost: 20,
            kilowattHours: 89.36018216122952,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.006797476334868404,
            cost: 4.2,
            kilowattHours: 18.616704616922817,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.0006797476334868405,
            cost: 0.42,
            kilowattHours: 1.8616704616922817,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
          ...
          },
          {
            ...
            accountName: testAccountName,
            cloudProvider: 'AWS',
            co2e: 0.001359495266973681,
            cost: 0.82,
            kilowattHours: 3.7233409233845634,
            region: 'us-east-1',
            serviceName: 'AmazonEC2',
            usesAverageCPUConstant: true,
            tags: {
