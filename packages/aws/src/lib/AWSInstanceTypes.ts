...
export const RDS_INSTANCE_FAMILY_TO_INSTANCE_TYPE_MAPPING: {
  [instanceFamily: string]: { [instanceSize: string]: number[] } // [vcpus, memory, scop,ns ]
} = {
  m6g: {
    large: [2, 6, 1.332856],
    xlarge: [4, 6, 1.332856],
    '2xlarge': [8, 6, 1.332856],
    '4xlarge': [16, 6, 1.332856],
    '8xlarge': [32, 16, 1.332856],
    '12xlarge': [48, 16, 1.332856],
    '16xlarge': [64, 26, 1.332856],
  },
  m5: {
    large: [2, 8, 1.6103792],
    xlarge: [4, 16, 1.6103792],
  ...
  m3: {
    medium: [1, 3.75, 1.4106656],
    large: [2, 7.5, 1.4106656],
    xlarge: [4, 15, 1.4106656],
    '2xlarge': [8, 30, 1.4106656],
  },
  m1: {
    small: [1, 1.7, 1.2442376],
    medium: [1, 3.75, 1.2442376],
    large: [2, 7.5, 1.2442376],
    xlarge: [4, 15, 1.2442376],
  },
  z1d: {
    large: [2, 16, 1.6103792],
    xlarge: [4, 32, 1.6103792],
    '2xlarge': [8, 64, 1.6103792],
    '3xlarge': [12, 96, 1.6103792],
    '6xlarge': [24, 192, 1.6103792],
    '12xlarge': [48, 384, 1.6103792],
  },
  x1e: {
    xlarge: [4, 122, 6.6922672],
    '2xlarge': [8, 244, 6.6922672],
    '4xlarge': [16, 488, 6.6922672],
    '8xlarge': [32, 976, 6.6922672],
    '16xlarge': [64, 1952, 6.6922672],
    '32xlarge': [128, 3904, 6.6922672],
  },
  x1: {
    '32xlarge': [128, 1952, 3.9850384],
    '16xlarge': [64, 976, 3.9850384],
  },
  r6g: {
    large: [2, 16, 1.6879024],
    xlarge: [4, 32, 1.6879024],
  ...
  r3: {
    large: [2, 15.25, 1.4162132],
    xlarge: [4, 30.5, 1.4162132],
    '2xlarge': [8, 61, 1.4162132],
    '4xlarge': [16, 122, 1.4162132],
    '8xlarge': [32, 244, 1.4162132],
  },
  m2: {
    xlarge: [2, 17.1, 1.4661416],
    '2xlarge': [4, 34.2, 1.4661416],
    '4xlarge': [8, 68.4, 1.4661416],
  },
  t3: {
    micro: [2, 1, 1.6103792],
    small: [2, 2, 1.6103792],
...
/*
export const ELASTICSEARCH_INSTANCE_FAMILY_TO_INSTANCE_TYPE_MAPPING: {
  [instanceFamily: string]: { [instanceSize: string]: number[] } // [vcpus, memory, scop,ns ]
} = {
  t3: {
    t3.small.elasticsearch	2	2	1610.3792	1.6103792
    t3.medium.elasticsearch	2	4	1610.3792	1.6103792
  },
  t2: {
    t2.micro.elasticsearch	1	1	1477.2368	1.4772368
    t2.small.elasticsearch	1	2	1477.2368	1.4772368
    t2.medium.elasticsearch	2	4	1477.2368	1.4772368
  },
  m5: {
    m5.large.elasticsearch	2	8	1610.3792	1.6103792
    m5.xlarge.elasticsearch	4	16	1610.3792	1.6103792
    m5.2xlarge.elasticsearch	8	32	1610.3792	1.6103792
    m5.4xlarge.elasticsearch	16	64	1610.3792	1.6103792
    m5.12xlarge.elasticsearch	48	192	1610.3792	1.6103792
  },
  m4: {
    m4.large.elasticsearch	2	8	1432.856	1.432856
    m4.xlarge.elasticsearch	4	16	1432.856	1.432856
    m4.2xlarge.elasticsearch	8	32	1432.856	1.432856
    m4.4xlarge.elasticsearch	16	64	1432.856	1.432856
    m4.10xlarge.elasticsearch	40	160	1432.856	1.432856
  },
  m3: {
    m3.medium.elasticsearch	1	3.75	1610.6656	1.6106656
    m3.large.elasticsearch	2	7.5	1610.6656	1.6106656
    m3.xlarge.elasticsearch	4	15	1610.6656	1.6106656
    m3.2xlarge.elasticsearch	8	30	1610.6656	1.6106656
  },
  c5: {
    c5.large.elasticsearch	2	4	1344.0944	1.3440944
    c5.xlarge.elasticsearch	4	8	1344.0944	1.3440944
    c5.2xlarge.elasticsearch	8	16	1344.0944	1.3440944
    c5.4xlarge.elasticsearch	16	32	1344.0944	1.3440944
    c5.9xlarge.elasticsearch	36	72	1344.0944	1.3440944
    c5.18xlarge.elasticsearch	72	144	1344.0944	1.3440944
  },
  c4: {
    c4.large.elasticsearch	2	3.75	1161.0236	1.1610236
    c4.xlarge.elasticsearch	4	7.5	1161.0236	1.1610236
    c4.2xlarge.elasticsearch	8	15	1161.0236	1.1610236
    c4.4xlarge.elasticsearch	16	30	1161.0236	1.1610236
    c4.8xlarge.elasticsearch	36	60	1161.0236	1.1610236
  },
  r5: {
    r5.large.elasticsearch	2	16	2142.9488	2.1429488
    r5.xlarge.elasticsearch	4	32	2142.9488	2.1429488
    r5.2xlarge.elasticsearch	8	64	2142.9488	2.1429488
    r5.4xlarge.elasticsearch	16	128	2142.9488	2.1429488
    r5.12xlarge.elasticsearch	48	384	2142.9488	2.1429488
  },
  r4: {
    r4.large.elasticsearch	2	15.25	1754.6168	1.7546168
    r4.xlarge.elasticsearch	4	30.5	1754.6168	1.7546168
    r4.2xlarge.elasticsearch	8	61	1754.6168	1.7546168
    r4.4xlarge.elasticsearch	16	122	1754.6168	1.7546168
    r4.8xlarge.elasticsearch	32	244	1754.6168	1.7546168
    r4.16xlarge.elasticsearch	64	488	1754.6168	1.7546168
  },
  t3: {},
  t3: {},
  t3: {},
  ...
  r4.8xlarge.elasticsearch	32	244	1754.6168	1.7546168
  r4.16xlarge.elasticsearch	64	488	1754.6168	1.7546168
  r3.large.elasticsearch	2	15.25	1616.2132	1.6162132
  r3.xlarge.elasticsearch	4	30.5	1616.2132	1.6162132
  r3.2xlarge.elasticsearch	8	61	1616.2132	1.6162132
  r3.4xlarge.elasticsearch	16	122	1616.2132	1.6162132
  r3.8xlarge.elasticsearch	32	244	1616.2132	1.6162132
  i3.large.elasticsearch	2	15.25	2587.9024	2.5879024
  i3.xlarge.elasticsearch	4	30.5	2587.9024	2.5879024
  i3.2xlarge.elasticsearch	8	61	2587.9024	2.5879024
  i3.4xlarge.elasticsearch	16	122	2587.9024	2.5879024
  i3.8xlarge.elasticsearch	32	244	2587.9024	2.5879024
  i3.16xlarge.elasticsearch	64	488	2587.9024	2.5879024
  i2.xlarge.elasticsearch	4	30.5	1616.2132	1.6162132
  i2.2xlarge.elasticsearch	8	61	1616.2132	1.6162132
  m6g.large.elasticsearch	2	8	1332.856	1.332856
  m6g.xlarge.elasticsearch	4	16	1332.856	1.332856
  m6g.2xlarge.elasticsearch	8	32	1332.856	1.332856
  m6g.4xlarge.elasticsearch	16	64	1332.856	1.332856
  m6g.8xlarge.elasticsearch	32	128	1332.856	1.332856
  m6g.12xlarge.elasticsearch	48	192	1332.856	1.332856
  c6g.large.elasticsearch	2	4	1155.3328	1.1553328
  c6g.xlarge.elasticsearch	4	8	1155.3328	1.1553328
  c6g.2xlarge.elasticsearch	8	16	1155.3328	1.1553328
  c6g.4xlarge.elasticsearch	16	32	1155.3328	1.1553328
  c6g.8xlarge.elasticsearch	32	64	1155.3328	1.1553328
  c6g.12xlarge.elasticsearch	48	96	1155.3328	1.1553328
  r6g.large.elasticsearch	2	16	1687.9024	1.6879024
  r6g.xlarge.elasticsearch	4	32	1687.9024	1.6879024
  r6g.2xlarge.elasticsearch	8	64	1687.9024	1.6879024
  r6g.4xlarge.elasticsearch	16	128	1687.9024	1.6879024
  r6g.8xlarge.elasticsearch	32	256	1687.9024	1.6879024
  r6g.12xlarge.elasticsearch	48	384	1687.9024	1.6879024
  r6gd.large.elasticsearch	2	16	1887.9024	1.8879024
  r6gd.xlarge.elasticsearch	4	32	1887.9024	1.8879024
  r6gd.2xlarge.elasticsearch	8	64	1887.9024	1.8879024
  r6gd.4xlarge.elasticsearch	16	128	1887.9024	1.8879024
  r6gd.8xlarge.elasticsearch	32	256	1887.9024	1.8879024
  r6gd.12xlarge.elasticsearch	48	384	1887.9024	1.8879024
  r6gd.16xlarge.elasticsearch	64	512	1887.9024	1.8879024
}
 */
