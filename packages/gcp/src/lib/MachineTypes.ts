...
export const INSTANCE_TYPE_COMPUTE_PROCESSOR_MAPPING: {
  ...
  n2: [COMPUTE_PROCESSOR_TYPES.CASCADE_LAKE.name],
  n2d: [COMPUTE_PROCESSOR_TYPES.AMD_EPYC_2ND_GEN.name],
  t2d: [COMPUTE_PROCESSOR_TYPES.AMD_EPYC_3RD_GEN.name],
  n1: skyLakeBroadwellHaswellSandyBridgeIvyBridge,
  c2: [COMPUTE_PROCESSOR_TYPES.CASCADE_LAKE.name],
  c2d: [COMPUTE_PROCESSOR_TYPES.AMD_EPYC_3RD_GEN.name],
  m2: broadwelCascadeLake,
  m1: broadwellSkylake,
  a2: [COMPUTE_PROCESSOR_TYPES.CASCADE_LAKE.name],
  [SHARED_CORE_PROCESSORS.E2_MICRO]: [COMPUTE_PROCESSOR_TYPES.UNKNOWN.name],
  [SHARED_CORE_PROCESSORS.E2_SMALL]: [COMPUTE_PROCESSOR_TYPES.UNKNOWN.name],
  [SHARED_CORE_PROCESSORS.E2_MEDIUM]: [COMPUTE_PROCESSOR_TYPES.UNKNOWN.name],
  [SHARED_CORE_PROCESSORS.F1_MICRO]: [COMPUTE_PROCESSOR_TYPES.UNKNOWN.name],
  [SHARED_CORE_PROCESSORS.G1_SMALL]: [COMPUTE_PROCESSOR_TYPES.UNKNOWN.name],
}
