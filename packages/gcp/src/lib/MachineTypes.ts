...
export const SHARED_CORE_PROCESSORS_VCPU_MAPPING: { [key: string]: number } = {
  [SHARED_CORE_PROCESSORS.E2_MICRO]: 0.5,
  [SHARED_CORE_PROCESSORS.E2_SMALL]: 1,
  [SHARED_CORE_PROCESSORS.E2_MEDIUM]: 2,
  [SHARED_CORE_PROCESSORS.F1_MICRO]: 0.2,
  [SHARED_CORE_PROCESSORS.G1_SMALL]: 0.5,
}
