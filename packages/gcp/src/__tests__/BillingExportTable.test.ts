...
describe('GCP BillingExportTable Service', () => {
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 16.775118291439796,
            co2e: 0.009662468135869321,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
          ...
          {
            kilowattHours: 0.2103994694162401,
            co2e: 0.00001662155808388297,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 11.644828717788574,
            co2e: 0.006707421341446219,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.10542922307649784,
            co2e: 0.00004354226913059361,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.3826927294968324,
            co2e: 0.0001580520972821918,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.34346251797510247,
            co2e: 0.00014185001992371733,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
      ...
      },
      {
        ...
        serviceEstimates: [
          {
            kilowattHours: 0.08654011845105183,
            co2e: 0.000058760740428264206,
            usesAverageCPUConstant: true,
            cloudProvider: 'GCP',
            accountId: accountId,
            accountName: accountName,
    ...
    const expectedResult: EstimationResult[] = [
      {
        ...
        serviceEstimates: [
          ...
          },
          {
            ...
            accountName: accountName,
            cloudProvider: 'GCP',
            co2e: 2.077583170499708,
            cost: 150,
            kilowattHours: 3059.7690287182736,
            tags: {},
            region: 'asia-south1',
          ...
          },
          {
            ...
            accountName: accountName,
            cloudProvider: 'GCP',
            co2e: 0.11234741205642347,
            cost: 350,
            kilowattHours: 272.02763209787764,
            tags: {},
            region: 'us-central1',
            serviceName: 'Kubernetes Engine',
            usesAverageCPUConstant: true,
  ...
  it('estimation for lookup table input data', async () => {
    ...
    const expectedResult: LookupTableOutput[] = [
      ...
      {
        co2e: 0.000004503250313774734,
        kilowattHours: 0.01394195143583509,
      ...
      {
        co2e: 0.000008507933513774733,
        kilowattHours: 0.026340351435835088,
